...
| # | 优化项 | 涉及文件 | 说明 | 优化方式 | 状态 |
|---|--------|----------|------|----------|------|
| 12 | 首屏骨架屏 | ContentList.tsx | 首次加载无占位 | 添加骨架屏组件，数据加载前展示占位 | ⬜ 待开始 |
| 13 | 图片懒加载 | ContentList.tsx, DetailPage.tsx | 图片加载策略 | 使用 loading="lazy" + Intersection Observer | ⬜ 待开始 |
| 14 | 路由预加载策略 | App.tsx | 详情页预加载 | requestIdleCallback 预加载 + hover/focus 预加载优化 | ⬜ 待开始 |
