...
- GitHub 远端 main 当前仍停留在 b5e9797，说明第九步补强修复尚未真正发布成功
- 当前线上用户仍在体验到的“首页卡顿、摘要仍偏长”更符合“远端还没吃到第九步补强修复”的状态
- 本轮后续动作应优先补发布 src/lib/utils.ts、src/services/aiSummaryService.ts、src/services/articleDetailService.ts、src/services/articleServiceEnhanced.ts、src/components/DetailPage.tsx 与三份根目录文件
